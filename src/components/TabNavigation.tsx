import { Kanban, BookOpen, StickyNote, CalendarDays, CircleDot, Settings2, ChevronUp, ChevronDown, RotateCcw, LucideIcon } from 'lucide-react';
...
export function TabNavigation() {
  const { activeTab, setActiveTab, tabOrder, moveTab, resetTabOrder } = useWorkspaceStore();

  ...
  return (
    <EditorContent
      ...
      className={cn(
        ...
        "[&_.ProseMirror_ul:not([data-type='taskList'])]:mb-3 [&_.ProseMirror_ul:not([data-type='taskList'])]:list-disc [&_.ProseMirror_ul:not([data-type='taskList'])]:pl-6",
        "[&_.ProseMirror_ul:not([data-type='taskList'])_ul]:mb-1 [&_.ProseMirror_ul:not([data-type='taskList'])_ul]:list-[circle] [&_.ProseMirror_ul:not([data-type='taskList'])_ul]:pl-6",
        ...
        "[&_.ProseMirror_li]:mb-1 [&_.ProseMirror_li>p]:my-0 [&_.ProseMirror_li::marker]:text-muted-foreground",
        "[&_.ProseMirror_ul[data-type='taskList']]:list-none [&_.ProseMirror_ul[data-type='taskList']]:pl-0",
        "[&_.ProseMirror_ul[data-type='taskList']_li]:mb-2",
